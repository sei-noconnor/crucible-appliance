...
- **Cert-Manager:** Automates certificate management, including the use of a "onprem.twn-imcite.net" root CA, ensuring secure communication.
...
Once deployed, access the Start page at [https://onprem.twn-imcite.net](https://onprem.twn-imcite.net)
