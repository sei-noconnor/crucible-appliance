...
- **Cert-Manager:** Automates certificate management, including the use of a "onprem.phl-imcite.net" root CA, ensuring secure communication.
...
Once deployed, access the Start page at [https://onprem.phl-imcite.net](https://onprem.phl-imcite.net)
